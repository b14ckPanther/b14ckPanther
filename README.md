...
<!-- Signal Header -->
![Status](https://readme-typing-svg.herokuapp.com/?lines=System:+ONLINE+//+Role:+Full+Stack+%26+AI+Engineer+//+Location:+Haifa,+IL&font=JetBrains%20Mono&center=true&width=800&height=30&duration=3000&pause=2000&color=38bdf8&size=20&vCenter=true)

<br/>

<!-- Core Grid: 60/40 Split -->
<table>
<tr>
...
I partner with founders to architect measurable software across FinTech, AI discovery, and immersive storytelling.
...
<!-- Shipments: 3-Column Project Cards -->
<table width="100%">
<tr>
...
Zero-based budgeting engine with Realtime Debt Sim.
...
Location-aware marketplace with Vector Search.

*Stack:* Flutter, Supabase, AI Search
...
Voice-driven sci-fi narrative engine.

*Stack:* Next.js, Framer Motion, LLM
